...
const Projects = () => {
  ...
  return (
    <section
      id="projects"
      className="flex flex-col justify-center items-center mt-60 font-mono text-neutral-100 text-lg text-pretty w-full sm:ml-20 md:w-[50rem]  xl:w-[90rem]" 
    >
      <h2 className="text-center text-nowrap text-4xl text-neutral-200 underline m-8 opacity-90 " style={{ textShadow: "3px 3px 2px"}}>
        Featured Projects
      </h2>
      <div className="h-[30rem] flex flex-col justify-center items-center  w-[25rem] ml-6 md:w-[45rem] xl:w-[40rem] lg:w-[54rem] ">
          ...
          {Array.from({ length: endPage - startPage + 1 }, (_, i) => (
            <li key={startPage + i} className="mx-1">
              <button
                ...
                } px-4 py-2 rounded-full focus:outline-none border-2 hover:bg-purple-400 border-sky-800 shadow-[0_0_2px_#fff,inset_0_0_2px_#fff,0_0_1px_#08f,0_0_1px_#08f,0_0_10px_#08f]`}
              >
                {startPage + i}
              </button>
            </li>
